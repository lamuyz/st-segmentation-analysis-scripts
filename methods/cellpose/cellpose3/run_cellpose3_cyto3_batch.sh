...
# Run Cellpose3-cyto3 on all tif/tiff images under an input directory.
#
# Usage:
#   bash run_cellpose3_cyto3_batch.sh <input_root> <output_root> <log_root> [gpu_id]
#
# Example:
#   bash run_cellpose3_cyto3_batch.sh \
#     /path/to/input_images \
#     /path/to/output/cellpose3_cyto3_default \
#     /path/to/logs/cellpose3_cyto3_default \
#     0
...
echo "========================================" | tee -a "$MAIN_LOG"
echo "Cellpose3-cyto3 batch run" | tee -a "$MAIN_LOG"
...
for IMAGE_PATH in "${TIF_FILES[@]}"; do
    ...
    if [ "$EXIT_CODE" -eq 0 ]; then
        ...
        echo "---- Last 60 lines of image log ----" | tee -a "$MAIN_LOG"
        tail -n 60 "$IMG_LOG" | tee -a "$MAIN_LOG"
        echo "------------------------------------" | tee -a "$MAIN_LOG"
...
echo "" | tee -a "$MAIN_LOG"
echo "========================================" | tee -a "$MAIN_LOG"
echo "All Cellpose3-cyto3 jobs finished." | tee -a "$MAIN_LOG"
