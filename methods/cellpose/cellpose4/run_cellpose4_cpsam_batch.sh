...
# Run Cellpose4-cpsam on all tif/tiff images under an input directory.
#
# Usage:
#   bash run_cellpose4_cpsam_batch.sh <input_root> <output_root> <log_root> [gpu_id]
#
# Example:
#   bash run_cellpose4_cpsam_batch.sh \
#     /path/to/input_images \
#     /path/to/output/cellpose4_cpsam_default \
#     /path/to/logs/cellpose4_cpsam_default \
#     0
...
echo "========================================" | tee -a "$MAIN_LOG"
echo "Cellpose4-cpsam batch run" | tee -a "$MAIN_LOG"
...
for IMAGE_PATH in "${TIF_FILES[@]}"; do
    ...
    OUT_DIR="$OUTPUT_ROOT/$REL_DIR/${STEM}_cellpose4_${MODEL_NAME}"
...
echo "" | tee -a "$MAIN_LOG"
echo "========================================" | tee -a "$MAIN_LOG"
echo "All Cellpose4-cpsam jobs finished." | tee -a "$MAIN_LOG"
